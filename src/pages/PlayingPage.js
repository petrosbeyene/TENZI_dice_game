...
export default function PlayingPage() {
    ...
    const calculateScore = () => {
       ...
       const score = 12000/(timeTaken*rollTaken)
    ...
    return (
        timeOut ? <Congrats newGame={resetGame} value={"You Lose!"} calcScore={0} timeOut={timeOut}/> : 
        tenzies ? <Congrats newGame={rollDice} value={"You win!"} calcScore={calculateScore()} timeOut={timeOut}/> :
